...
const FromListPreview = ({ invoiceData ,setIsPreviewOpen,previewPhoto,companyAddress,companyGST}) => {
    const {
        invoiceDetails,
        billTo,
        billFrom,
...
//   ----------------------------------
    return (
        ...
        <div className='d-flex align-items-center justify-content-between  PreviewInvoiceMainBox' style={{background:"white"}}>
<div>
...
{/* <button className="invoice-button save-button" onClick={handleShare}>Share</button> */}
</div>
...
export default FromListPreview;
